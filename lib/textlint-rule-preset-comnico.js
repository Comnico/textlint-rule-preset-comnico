...
module.exports = {
  rules: {
    ...
    "hiragana-daimeishi": moduleInterop(require("textlint-rule-ja-hiragana-daimeishi")),
    "hiragana-fukushi": moduleInterop(require("textlint-rule-ja-hiragana-fukushi")),
    "hiragana-hojodoushi": moduleInterop(require("textlint-rule-ja-hiragana-hojodoushi")),
    "textlint-rule-ja-keishikimeishi": moduleInterop(require("textlint-rule-ja-keishikimeishi")),
    "textlint-rule-ja-no-abusage": moduleInterop(require("textlint-rule-ja-no-abusage")),
